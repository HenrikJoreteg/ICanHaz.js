(function(){(function(){var b={VERSION:"0.10.1",templates:{},$:"undefined"!==typeof window?window.jQuery||window.Zepto||null:null,addTemplate:function(a,d){if("object"===typeof a)for(var e in a)this.addTemplate(e,a[e]);else b[a]?console.error("Invalid name: "+a+"."):b.templates[a]?console.error('Template "'+a+'  " exists'):(b.templates[a]=d,b[a]=function(c,d){var c=c||{},e=Mustache.to_html(b.templates[a],c,b.templates);return b.$&&!d?b.$(e):e})},clearAll:function(){for(var a in b.templates)delete b[a];
b.templates={}},refresh:function(){b.clearAll();b.grabTemplates()},grabTemplates:function(){var a,d,e=document.getElementsByTagName("script"),c,f=[];for(a=0,d=e.length;a<d;a++)if((c=e[a])&&c.innerHTML&&c.id&&("text/html"===c.type||"text/x-icanhaz"===c.type))b.addTemplate(c.id,"".trim?c.innerHTML.trim():c.innerHTML.replace(/^\s+/,"").replace(/\s+$/,"")),f.unshift(c);for(a=0,d=f.length;a<d;a++)f[a].parentNode.removeChild(f[a])}};"undefined"!==typeof require?module.exports=b:window.ich=b;"undefined"!==
